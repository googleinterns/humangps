...
DEFINE_string output "/cns/tp-d/home/yindaz/human_correspondence/dataset/surreal/sstables_512/test.sst" "Output SSTable path"
DEFINE_int shards 1 "Number of shards."
DEFINE_string sample_pkl_path "/cns/tp-d/home/yindaz/human_correspondence/dataset/surreal/smpl_param_pkl/intra_sample_train_all_900000.pkl" "Samples pkl path."
...
rabbit --verifiable build -c opt vr/perception/deepholodeck/human_correspondence/data/smpl/to_tf_example_pipeline.par

readonly G3BIN="$(rabbit info blaze-bin -c opt --force_python=PY3)"

"${G3BIN}/vr/perception/deepholodeck/human_correspondence/data/smpl/to_tf_example_pipeline.par" \
